    ...
    return (
        <header className="sticky top-0 bg-white">
            <div className="flex w-full p-6 items-center">
                ...
                <form className="flex flex-grow border border-gray-200 rounded-full cursor-pointer
                shadow-lg max-w-3xl items-center px-6 py-3 ml-10 mr-5">
                    ...
                    />
                    <MicrophoneIcon className="h-6 text-blue-500 border-l-2 cursor-pointer mr-3 hidden sm:inline-flex pl-4 border-gray-300"  />
                    <SearchIcon className="h-6
                    text-blue-500 hidden sm:inline-flex" />
                    <button hidden type="submit" onClick={search}>Search</button>
                </form>
                <Avatar className="ml-auto" url='https://www.w3schools.com/howto/img_avatar.png' />
            </div>
